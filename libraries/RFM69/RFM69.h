...
#define RF69_SPI_CS            	7 // PA7 on ATtiny84 which is clockwise / NOT alternative (https://github.com/SpenceKonde/ATTinyCore/issues/116)
...
/*#elif defined(__AVR_ATtiny84__)
  #define RF69_IRQ_PIN          2*/
#elif defined(__AVR_ATtiny84__)
  #define RF69_IRQ_PIN          8
#else
  #define RF69_IRQ_PIN          2
#endif

#define IS_RFM69HW 0	// HW module is being used, otherwise there's no need for the HW code
#define USE_ENCRYPTION 0

#define CSMA_LIMIT              -90 // upper RX signal sensitivity threshold in dBm for carrier sense access
#define RF69_MODE_SLEEP         0 // XTAL OFF
#define RF69_MODE_STANDBY       4 // was 1 // XTAL ON
#define RF69_MODE_SYNTH         8 // was 2 // PLL ON
#define RF69_MODE_RX            16 // was 3 // RX MODE
#define RF69_MODE_TX            12 // was 4 // TX MODE
...
class RFM69 {
  public:
    ...
    RFM69(uint8_t slaveSelectPin=RF69_SPI_CS, bool isRFM69HW=false)
		: _slaveSelectPin(slaveSelectPin),
			_promiscuousMode(false)
#if IS_RFM69HW
      , _powerLevel(31), _isRFM69HW(isRFM69HW)
#endif
	{
